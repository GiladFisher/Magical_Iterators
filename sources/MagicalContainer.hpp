...
namespace ariel{
    class MagicalContainer{
        ...
        public:
            ...
            int size(); // return size of original container
            ...
            class PrimeIterator{
                ...
                public:
                    ...
                    int end() const; // return size of prime container
            ...
            class AscendingIterator{
                ...
                public:
                    ...
                    int end() const; // return size of sorted container 
            ...
            class SideCrossIterator{
                ...
                public:
                    ...
                    int end() const; // return size of cross container 
